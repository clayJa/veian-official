        ...
        <div class="wrapper">
          <div class="show-box clearfix" v-for="(item, i) in showInfoList" :key="i">
            <div class="box-item row row-no-gutters">
              ...
              <div :class="`img-wrapper col-md-6 col-xs-12`">
      ...
      <div class="third-block">
        <div class="wrapper">
          <div class="page-title-nav">
            ...
            <div class="title">十大人才岗位，期待你的加入</div>
      ...
      showInfoList: [
        {
          ...
          titleDesc: 'About us',
          title: '我们是',
          content: `我们是在做好公司，更在努力成为好伙伴。
                  世上总有那家别人的公司，
                  未苒则一直努力成为"我们的公司"。
                  从开始到现在，值得同事始终留恋、合作伙伴恒久信任，
                  这是坚定不移的目标。
                  要每一步走得踏实，方能下一步更加稳固。`,
        ...
        },
        {
          ...
          titleDesc: 'About us',
          title: '我可以',
          content: `我能大胆启用，为梦想提供停留的地方。
                  在未苒，衡量标准并不唯一。
                  学历并不代表能力，文凭只是参考。
                  对老员工心生感恩，对新伙伴诚心对待。
                  把未苒人的梦想，当做自己的梦想去努力实现。
                  不为嘉奖，只为让所行之事存在价值。`,
